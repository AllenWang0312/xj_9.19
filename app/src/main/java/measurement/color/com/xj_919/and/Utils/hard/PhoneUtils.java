...
public class PhoneUtils {
    ...
    public static void isUsbHostEnable(Context context) {
        boolean b = context.getPackageManager().hasSystemFeature("android.hardware.usb.host");
        Toast.makeText(context, "该设备" + (b ? "可以" : "不可以") + "使用usbhost功能", Toast.LENGTH_SHORT).show();
    }
